...
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD', 'juXGXR3AFfC3KlwMqmzh')
EMAIL_TIMEOUT = 10
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'Церковь Христианской Жизни <bot.kclc@mail.ru>')

# Если пароль указан — шлём через реальный SMTP mail.ru. Иначе выводим в консоль терминала
